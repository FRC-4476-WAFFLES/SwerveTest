...
public class SequentialTest extends SequentialCommandGroup {
  ...
  public SequentialTest(DriveSubsystem driveSubsystem) {
    TrajectoryConfig config = new TrajectoryConfig(0.5, 0.1).setKinematics(driveSubsystem.kinematics);
    ...
    addCommands(new DriveStraight(driveSubsystem, trajectory));
  }
}
